...
//    Page<AttendanceDTO> attendanceDTOS = attendanceService.getAttendanceByMonth(year, month, day, pageable);
...
//                           @RequestParam("employeeIds") Integer[] employeeIds) {
...
//        AttendanceDTO attendanceDTO = attendanceService.getTodayAttendanceByEmployeeId(employeeId);
//        attendances.add(attendanceDTO);
//      }
//    }
//    attendanceCreationDTO.setAttendances(attendances);
//
...
//                               @ModelAttribute("attendanceCreationDTO") AttendanceCreationDTO dto,
...
//    }
//
//    attendanceService.updateAttendances(dto);
//
//    model.addAttribute("fragments", "fragments/attendance-create");
//    return "index";
//  }
